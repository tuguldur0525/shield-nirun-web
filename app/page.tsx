    ...
    <main className="bg-white text-gray-900">
            ...
            <div className="grid w-full items-center gap-10 lg:gap-12 xl:gap-14 md:grid-cols-12">
              ...
              <div className="md:col-span-7">
                ...
                <p className="mt-5 max-w-2xl text-base leading-relaxed text-gray-600 sm:text-lg xl:text-[1.05rem]">
                 Shield Nirun нь уламжлалт хамгаалалтын үйлчилгээг хиймэл оюун ухаанд суурилсан дэвшилтэт технологитой хослуулсан шинэ үеийн хамгаалалтын компани юм. Бид 10 гаруй жилийн туршлагатай, олон улсын стандартын дагуу ажилладаг мэргэшсэн багийн хамтаар хувь хүн, байгууллага, арга хэмжээнд зориулсан ухаалаг, найдвартай хосолмол хамгаалалтын шийдлүүдийг санал болгоно. 
                </p>
              ...
              <div className="md:col-span-5">
                <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-1 xl:gap-4">
                  {[
                    {
                      t: "Уламжлалт харуул хамгаалалт",
                      d: "Туршлагатай харуул хамгаалалтын баг, орчин үеийн технологиор тоноглогдсон хамгаалалтын шийдэл.",
                      href: "/tech/ai-drone",
                    },
                    {
                      t: "Хотхон болон оффисын барилгын аюулгүй байдлын цогц шийдэл",
                      d: "Оршин суугчдын тав тух, аюулгүй байдлыг бүрэн хангах зорилгоор хүний оролцоо болон технологийн дэвшлийг хослуулсан.",
                      href: "/tech/cloud-monitoring",
                    },
                    {
                      t: "Хяналтын камер, дохиолол, зогсоолын гарцын төлөвлөлт, суурилуулалт, тохиргоо",
                      d: "Байгууллага, албан газар, худалдаа үйлчилгээний төвүүдэд зориулсан камерын систем, дохиолол, зогсоолын гарцын шийдэл.",
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="flex flex-col gap-3">
            ...
            <p className="max-w-7xl text-gray-700 leading-relaxed">
        ...
        <div className="mx-auto max-w-6xl px-6 py-8 lg:px-8 xl:max-w-[76rem] 2xl:max-w-[86rem]">
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-.xl text-gray-700 leading-relaxed">
             Бид аюулгүй байдлыг нэг удаагийн үйлчилгээ бус, стандартчлагдсан, хэмжигдэхүйц, тогтвортой систем байдлаар хэрэгжүүлдэг; эрсдэлийн үнэлгээ, хэрэгжилт, тасралтгүй хяналт, тайлагналын нэг циклээр ажиллаж, технологид суурилсан шийдлээр үр дүнг бодитоор нэмэгдүүлдэг бөгөөд хамгаалалт, зөвлөх үйлчилгээ, сургалт, техникийн шийдлийг нэг цонхоор, нэг хариуцлагын дор санал болгодог найдвартай түнш юм.
            </p>
      ...
      <section className="relative overflow-hidden py-1">
        ...
        <div className="mx-auto max-w-6xl px-6 py-8 lg:px-8 xl:max-w-[76rem] 2xl:max-w-[86rem]">
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-7xl text-gray-700 leading-relaxed">
              Бид ажил эхлэхийн өмнө харилцагчийн хэрэгцээ, зорилго, объектын нөхцөл байдлыг нарийвчлан тодорхойлж, боломжит эрсдэлүүдэд мэргэжлийн үнэлгээ хийсний үндсэн дээр тохирсон төлөвлөгөө боловсруулдаг. Энэхүү төлөвлөгөөг бодит нөхцөлд хэрэгжүүлж, үйлчилгээний явцад тогтмол хяналт, шалгалт хийж, гүйцэтгэлд үнэлгээ өгдөг бөгөөд гарсан үр дүнг ойлгомжтой тайлангаар хүргэн, шаардлагатай сайжруулалтыг үе шаттайгаар хэрэгжүүлснээр үйлчилгээний чанарыг тасралтгүй сайжруулж ажилладаг.
            </p>
          </div>
